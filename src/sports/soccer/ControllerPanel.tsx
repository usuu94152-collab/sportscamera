...
export function SoccerControllerPanel({ state, timerDisplayMs, dispatch }: Props) {
  const periods = ["전반", "후반"];
      ...
      <div className="score-row">
        <div className="team-block">
          ...
          <div className="score-buttons">
            <button onClick={() => dispatch({ type: "HOME_SCORE", delta: 1 })}>+1</button>
            <button className="minus-btn" onClick={() => dispatch({ type: "HOME_SCORE", delta: -1 })}>-1</button>
          </div>
        </div>
        ...
        <div className="team-block">
          ...
          <div className="score-buttons">
            <button onClick={() => dispatch({ type: "AWAY_SCORE", delta: 1 })}>+1</button>
            <button className="minus-btn" onClick={() => dispatch({ type: "AWAY_SCORE", delta: -1 })}>-1</button>
          </div>
        </div>
      </div>
